...
@pytest.mark.parametrize("topic, payload, expected_type, expected_data", [
    ("ent1/fac1/area5", b'{"key": "value"}', JSONPayload, {
        "key": "value"
    }),
    ("spBv1.0/uns_group/STATE",
     b'{"status": "offline", "timestamp": 123456789}', JSONPayload, {
         "status": "offline",
         "timestamp": 123456789,
     }),
    ("spBv1.0/uns_group/NBIRTH/eon1", sample_spb_payload, BytesPayload,
     sample_spb_payload),
    ("spBv1.0/uns_group/NDATA/eon1", sample_spb_payload, BytesPayload,
     sample_spb_payload),
])
