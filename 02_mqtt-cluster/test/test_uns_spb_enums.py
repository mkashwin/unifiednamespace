...
def check_other_slots(value, spb_obj, enum_list, enum):
    ...
    for datatype in enum_list:
        if datatype != SPBBasicDataTypes.Unknown:
            ...
            if (
                datatype.get_field_name() != enum.get_field_name() and type(
                    retrieved_value) is type(value)
...
@pytest.mark.parametrize(
    ...
    [
        (10, sparkplug_b_pb2.Payload.Metric(),
         SPBMetricDataTypes, 10, sparkplug_b_pb2.UInt8),
        (10, sparkplug_b_pb2.Payload.Metric(),
         SPBMetricDataTypes, 10, sparkplug_b_pb2.Int8),
        (-10, sparkplug_b_pb2.Payload.Metric(),
         SPBMetricDataTypes, -10 + 2**8, sparkplug_b_pb2.Int8),
        (10, sparkplug_b_pb2.Payload.Metric(),
         SPBMetricDataTypes, 10, sparkplug_b_pb2.UInt16),
        (10, sparkplug_b_pb2.Payload.Metric(),
         SPBMetricDataTypes, 10, sparkplug_b_pb2.Int16),
        (-10, sparkplug_b_pb2.Payload.Metric(),
         SPBMetricDataTypes, -10 + 2**16, sparkplug_b_pb2.Int16),
        (10, sparkplug_b_pb2.Payload.Metric(),
         SPBMetricDataTypes, 10, sparkplug_b_pb2.UInt32),
        (10, sparkplug_b_pb2.Payload.Metric(),
         SPBMetricDataTypes, 10, sparkplug_b_pb2.Int32),
        (-10, sparkplug_b_pb2.Payload.Metric(),
         SPBMetricDataTypes, -10 + 2**32, sparkplug_b_pb2.Int32),
        (20, sparkplug_b_pb2.Payload.Template.Parameter(),
         SPBParameterTypes, 20, sparkplug_b_pb2.UInt32),
        (30, sparkplug_b_pb2.Payload.DataSet.DataSetValue(),
         SPBDataSetDataTypes, 30, sparkplug_b_pb2.UInt32),
        (40, sparkplug_b_pb2.Payload.PropertyValue(),
         SPBPropertyValueTypes, 40, sparkplug_b_pb2.UInt32),
    ],
)
def test_int_value_via_enum(value: int, spb_obj, spb_enum_types, expected_value: int, spb_datatype: int):
    ...
    """
    spb_enum_types(spb_datatype).set_value_in_sparkplug(
        value=value, spb_object=spb_obj)
    ...
    check_other_slots(value, spb_obj, spb_enum_types,
                      SPBBasicDataTypes(spb_datatype))
...
@pytest.mark.parametrize(
    ...
    [
        (10, sparkplug_b_pb2.Payload.Metric(),
         SPBMetricDataTypes, 10, sparkplug_b_pb2.UInt64),
        (10, sparkplug_b_pb2.Payload.Metric(),
         SPBMetricDataTypes, 10, sparkplug_b_pb2.Int64),
        (-10, sparkplug_b_pb2.Payload.Metric(),
         SPBMetricDataTypes, -10 + 2**64, sparkplug_b_pb2.Int64),
        (123456, sparkplug_b_pb2.Payload.Metric(),
         SPBMetricDataTypes, 123456, sparkplug_b_pb2.DateTime),
        (20, sparkplug_b_pb2.Payload.Template.Parameter(),
         SPBParameterTypes, 20, sparkplug_b_pb2.UInt64),
        (30, sparkplug_b_pb2.Payload.DataSet.DataSetValue(),
         SPBDataSetDataTypes, 30, sparkplug_b_pb2.UInt64),
        (40, sparkplug_b_pb2.Payload.PropertyValue(),
         SPBPropertyValueTypes, 40, sparkplug_b_pb2.UInt64),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (-20.0, sparkplug_b_pb2.Payload.Template.Parameter(), SPBParameterTypes, -20.0),
        (30.0, sparkplug_b_pb2.Payload.DataSet.DataSetValue(),
         SPBDataSetDataTypes, 30.0),
        (-30.0, sparkplug_b_pb2.Payload.DataSet.DataSetValue(),
         SPBDataSetDataTypes, -30.0),
...
def test_float_value_via_enum(value: float, spb_obj, spb_enum_types, expected_value: float):
    ...
    """
    spb_enum_types(sparkplug_b_pb2.Float).set_value_in_sparkplug(
        value=value, spb_object=spb_obj)
    # check raw value in the slot
    assert (
    ...
    # check encoded value matches original value
    assert spb_enum_types(sparkplug_b_pb2.Float).get_value_function(
        spb_obj) == expected_value
...
def test_double_value_via_enum(value: float, spb_obj, spb_enum_types, expected_value: float):
    ...
    """
    spb_enum_types(sparkplug_b_pb2.Double).set_value_in_sparkplug(
        value=value, spb_object=spb_obj)
    # check raw value in the slot
    assert (
    ...
    # check encoded value matches original value
    assert spb_enum_types(
        sparkplug_b_pb2.Double).get_value_function(spb_obj) == value
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (True, sparkplug_b_pb2.Payload.DataSet.DataSetValue(),
         SPBDataSetDataTypes, True),
        (False, sparkplug_b_pb2.Payload.DataSet.DataSetValue(),
         SPBDataSetDataTypes, False),
...
def test_boolean_value_via_enum(value: bool, spb_obj, spb_enum_types, expected_value: bool):
    ...
    spb_enum_types(sparkplug_b_pb2.Boolean).set_value_in_sparkplug(
        value=value, spb_object=spb_obj)
    ...
    assert spb_enum_types(sparkplug_b_pb2.Boolean).get_value_function(
        spb_obj) == expected_value
...
@pytest.mark.parametrize(
    "value, spb_obj, spb_enum_types,expected_value,spb_datatype",
    [
        ("Test String", sparkplug_b_pb2.Payload.Metric(),
         SPBMetricDataTypes, "Test String", sparkplug_b_pb2.String),
        (
            """Test Text\nLine2""",
...
def test_string_value_via_enum(value: str, spb_obj, spb_enum_types, expected_value: str, spb_datatype):
    ...
    check_other_slots(value, spb_obj, spb_enum_types,
                      spb_enum_types(spb_datatype))
    # check encoded value matches original value
    assert spb_enum_types(sparkplug_b_pb2.String).get_value_function(
        spb_obj) == expected_value
...
@pytest.mark.parametrize(
    "value, spb_obj, spb_enum_types, expected_value",
    [
        (bytes("Test String1", "utf-8"), sparkplug_b_pb2.Payload.Metric(),
         SPBMetricDataTypes, bytes("Test String1", "utf-8")),
        (
            bytes("""Test String2\nLine2""", "utf-8"),
            sparkplug_b_pb2.Payload.Metric(),
            SPBMetricDataTypes,
...
def test_bytes_value_via_enum(value: bytes, spb_obj, spb_enum_types, expected_value: bytes):
    ...
    Test case for value setting boolean via the ENUMs
    """
    spb_enum_types(sparkplug_b_pb2.Bytes).set_value_in_sparkplug(
        value=value, spb_object=spb_obj)
    assert (
        spb_obj.bytes_value == expected_value
    ), f"Expecting metric value to be: {expected_value}, but got {spb_obj.bytes_value}"
    check_other_slots(value, spb_obj, spb_enum_types,
                      SPBAdditionalDataTypes.Bytes)
    # check encoded value matches original value

    assert spb_enum_types(sparkplug_b_pb2.Bytes).get_value_function(
        spb_obj) == expected_value
...
def test_file_value_via_enum(value: bytes, spb_obj, spb_enum_types, expected_value: bytes):
    ...
    Test case for value setting boolean via the ENUMs
    """
    spb_enum_types(sparkplug_b_pb2.File).set_value_in_sparkplug(
        value=value, spb_object=spb_obj)
    assert (
        spb_obj.bytes_value == expected_value
    ), f"Expecting metric value to be: {expected_value}, but got {spb_obj.bytes_value}"
    check_other_slots(value, spb_obj, spb_enum_types,
                      SPBAdditionalDataTypes.File)
    # check encoded value matches original value

    assert spb_enum_types(sparkplug_b_pb2.File).get_value_function(
        spb_obj) == expected_value
...
@pytest.mark.parametrize(
    ...
    [
        (sparkplug_b_pb2.Payload.DataSet(),
         sparkplug_b_pb2.Payload.Metric()),  # positive test case
...
def test_dataset_via_enum(value: sparkplug_b_pb2.Payload.DataSet, spb_obj):
    ...
    if isinstance(value, sparkplug_b_pb2.Payload.DataSet):
        ...
        SPBMetricDataTypes(sparkplug_b_pb2.DataSet).set_value_in_sparkplug(
            value=value, spb_object=spb_obj)
        # check raw value in the slot
        assert spb_obj.dataset_value == value
        check_other_slots(value, spb_obj, SPBMetricDataTypes,
                          SPBAdditionalDataTypes.DataSet)
        # check encoded value matches original value
        assert SPBMetricDataTypes(
            sparkplug_b_pb2.DataSet).get_value_function(spb_obj) == value
    else:
...
@pytest.mark.parametrize(
    "value, spb_obj",
    [
        (sparkplug_b_pb2.Payload.Template(),
         sparkplug_b_pb2.Payload.Metric()),  # positive test case
        ("String", sparkplug_b_pb2.Payload.Metric()),  # negative test case
    ],
)
def test_template_via_enum(value, spb_obj):
    ...
    if isinstance(value, sparkplug_b_pb2.Payload.Template):
        SPBMetricDataTypes(sparkplug_b_pb2.Template).set_value_in_sparkplug(
            value=value, spb_object=spb_obj)
        # check raw value in the slot
        assert spb_obj.template_value == value
        check_other_slots(value, spb_obj, SPBMetricDataTypes,
                          SPBAdditionalDataTypes.Template)
        # check encoded value matches original value
        assert SPBMetricDataTypes(
            sparkplug_b_pb2.Template).get_value_function(spb_obj) == value
    else:
        with pytest.raises(ValueError):
            SPBMetricDataTypes(sparkplug_b_pb2.Template).set_value_in_sparkplug(
                value=value, spb_object=spb_obj)
...
@pytest.mark.parametrize(
    "value, spb_obj",
    [
        (sparkplug_b_pb2.Payload.PropertySet(),
         sparkplug_b_pb2.Payload.PropertyValue()),  # positive test case
...
def test_propertyset_via_enum(value: sparkplug_b_pb2.Payload.PropertySet, spb_obj):
    ...
    if isinstance(value, sparkplug_b_pb2.Payload.PropertySet):
        SPBPropertyValueTypes(sparkplug_b_pb2.PropertySet).set_value_in_sparkplug(
            value=value, spb_object=spb_obj)
        # check raw value in the slot
        assert spb_obj.propertyset_value == value
        check_other_slots(value, spb_obj, SPBPropertyValueTypes,
                          SPBPropertyValueTypes.PropertySet)
        # check encoded value matches original value
        assert SPBPropertyValueTypes(
            sparkplug_b_pb2.PropertySet).get_value_function(spb_obj) == value
    else:
        with pytest.raises(ValueError):
            SPBPropertyValueTypes(sparkplug_b_pb2.PropertySet).set_value_in_sparkplug(
                value=value, spb_object=spb_obj)
...
@pytest.mark.parametrize(
    "value, spb_obj",
    [
        (sparkplug_b_pb2.Payload.PropertySetList(),
         sparkplug_b_pb2.Payload.PropertyValue()),  # positive test case
        ("String", sparkplug_b_pb2.Payload.PropertyValue()),  # negative test case
    ],
)
def test_propertyset_list_via_enum(value: sparkplug_b_pb2.Payload.PropertySetList, spb_obj):
    ...
    if isinstance(value, sparkplug_b_pb2.Payload.PropertySetList):
        SPBPropertyValueTypes(sparkplug_b_pb2.PropertySetList).set_value_in_sparkplug(
            value=value, spb_object=spb_obj)
        ...
        # check encoded value matches original value
        assert SPBPropertyValueTypes(
            sparkplug_b_pb2.PropertySetList).get_value_function(spb_obj) == value
    else:
        with pytest.raises(ValueError):
            SPBPropertyValueTypes(sparkplug_b_pb2.PropertySetList).set_value_in_sparkplug(
                value=value, spb_object=spb_obj)
...
def test_unknown_via_enum(value, spb_obj, spb_enum_types):
    spb_enum_types(sparkplug_b_pb2.Unknown).set_value_in_sparkplug(
        value, spb_object=spb_obj)
    check_other_slots(value, spb_obj, spb_enum_types,
                      SPBBasicDataTypes.Unknown)
    # check encoded value matches original value
    assert spb_enum_types(
        sparkplug_b_pb2.Unknown).get_value_from_sparkplug(spb_obj) is None
...
@pytest.mark.parametrize(
    ...
    [  # test data taken from https://sparkplug.eclipse.org/specification/version/3.0/documents/sparkplug-specification-3.0.0.pdf
        ...
        (sparkplug_b_pb2.Int8Array,
         [-23, 123], sparkplug_b_pb2.Payload.Metric(), bytes([0xE9, 0x7B])),
        (sparkplug_b_pb2.Int16Array,
         [-30000, 30000], sparkplug_b_pb2.Payload.Metric(), bytes([0xD0, 0x8A, 0x30, 0x75])),
        (
        ...
        (
            ...
            sparkplug_b_pb2.Payload.Metric(),
            bytes([0xCE, 0x06, 0x72, 0xAC, 0x18, 0x9C, 0xBA, 0xC4,
                  0xC4, 0xBA, 0x9C, 0x18, 0xAC, 0x72, 0x06, 0xCE]),
        ),
        (sparkplug_b_pb2.UInt8Array, [
         23, 250], sparkplug_b_pb2.Payload.Metric(), bytes([0x17, 0xFA])),
        (sparkplug_b_pb2.UInt16Array, [
         30, 52360], sparkplug_b_pb2.Payload.Metric(), bytes([0x1E, 0x00, 0x88, 0xCC])),
        (
        ...
        (
            ...
            sparkplug_b_pb2.Payload.Metric(),
            bytes([0x34, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        (
            ...
            little_to_big_endian(
                [0x40, 0x28, 0xB5, 0x5B, 0x68, 0x05, 0xA2, 0xD7,
                    0x40, 0x8F, 0xF7, 0x4C, 0x6F, 0x1C, 0x17, 0x8E], 8
            ),
        ),
        ...
        (
            ...
            sparkplug_b_pb2.Payload.Metric(),
            bytes([0xC7, 0xD0, 0x90, 0x75, 0x24, 0x01, 0x00, 0x00,
...
def test_set_arrays(array_type, value: list[int | str | bool | bytes], spb_obj, encoded_bytes: bytes):
    SPBMetricDataTypes(array_type).set_value_in_sparkplug(
        value=value, spb_object=spb_obj)
    assert spb_obj.bytes_value == encoded_bytes
    check_other_slots(encoded_bytes, spb_obj,
                      SPBBasicDataTypes, SPBAdditionalDataTypes.Bytes)
    check_other_slots(encoded_bytes, spb_obj,
                      SPBAdditionalDataTypes, SPBAdditionalDataTypes.Bytes)
    #  check if the array is correctly decoded back from the byte array
    assert SPBMetricDataTypes(
        array_type).get_value_from_sparkplug(spb_obj) == value
...
@pytest.mark.parametrize(
    ...
    [  # test data taken from https://sparkplug.eclipse.org/specification/version/3.0/documents/sparkplug-specification-3.0.0.pdf
        (
            ...
            little_to_big_endian(
                [0x3F, 0x9D, 0x70, 0xA4, 0x42, 0xB2, 0xAE, 0x98], 4),
        ),
    ],
)
def test_set_float_arrays(array_type, value: list[float], spb_obj, encoded_bytes: bytes):
    ...
    check_other_slots(encoded_bytes, spb_obj,
                      SPBAdditionalDataTypes, SPBAdditionalDataTypes.Bytes)
    #  check if the array is correctly decoded back from the byte array
    decoded_values = SPBMetricDataTypes(
        array_type).get_value_from_sparkplug(spb_obj)
    for original, decoded in zip(value, decoded_values, strict=True):
