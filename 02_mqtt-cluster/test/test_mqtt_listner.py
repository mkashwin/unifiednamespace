...
def test_01_unauthenticated_connections(clean_session, protocol, transport,
    ...
    """
    uns_client = UnsMQTTClient(f"test_01_{protocol}",
...
def test_02_authenticated_connections(clean_session, protocol, transport, port,
    ...
    """
    uns_client = UnsMQTTClient(f"test_01_{protocol}_",
                               clean_session=clean_session,
                               protocol=protocol,
                               transport=transport,
                               reconnect_on_failure=reconnect_on_failure)
...
def test_filter_ignored_attributes(topic: str, json_dict: dict,
    ...
    """
    result = UnsMQTTClient.filter_ignored_attributes(topic, json_dict,
