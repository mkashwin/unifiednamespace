...
@pytest.mark.parametrize(
    "value,metric, metric_value, spb_datatype",
    [
        (10, SimpleNamespace(**metric_dict), 10, sparkplug_b_pb2.UInt8),
        (10, SimpleNamespace(**metric_dict), 10, sparkplug_b_pb2.Int8),
        (-10, SimpleNamespace(**metric_dict), -10 + 2**8, sparkplug_b_pb2.Int8),
        (10, SimpleNamespace(**metric_dict), 10, sparkplug_b_pb2.UInt16),
        (10, SimpleNamespace(**metric_dict), 10, sparkplug_b_pb2.Int16),
        (-10, SimpleNamespace(**metric_dict), -10 + 2**16, sparkplug_b_pb2.Int16),
        (10, SimpleNamespace(**metric_dict), 10, sparkplug_b_pb2.UInt32),
        (10, SimpleNamespace(**metric_dict), 10, sparkplug_b_pb2.Int32),
        (-10, SimpleNamespace(**metric_dict), -10 + 2**32, sparkplug_b_pb2.Int32),
    ],
)
def test_set_int_value_via_enum(value: int, metric: dict, metric_value: int, spb_datatype: int):
    """
    ...
    for my_enum_type in [SPBBasicDataTypes, SPBMetricDataTypes, SPBPropertyValueTypes, SPBDataSetDataTypes]:
        my_enum_type(spb_datatype).set_value_in_sparkplug(value=value, spb_object=metric)
...
@pytest.mark.parametrize(
    "value,metric, metric_value,spb_datatype",
    [
        (10, SimpleNamespace(**metric_dict), 10, sparkplug_b_pb2.UInt64),
        (10, SimpleNamespace(**metric_dict), 10, sparkplug_b_pb2.Int64),
        (-10, SimpleNamespace(**metric_dict), -10 + 2**64, sparkplug_b_pb2.Int64),
        (123456, SimpleNamespace(**metric_dict), 123456, sparkplug_b_pb2.DateTime),
    ],
)
def test_set_long_value_via_enum(value: int, metric: dict, metric_value: int, spb_datatype: int):
    """
...
def test_set_float_value_via_enum(value: float, metric: dict, metric_value: float):
    """
    Test case for setting float value via the ENUMs
    """
    for my_enum_type in [SPBBasicDataTypes, SPBMetricDataTypes, SPBPropertyValueTypes, SPBDataSetDataTypes]:
        my_enum_type(sparkplug_b_pb2.Float).set_value_in_sparkplug(value=value, spb_object=metric)
        assert (
...
def test_set_double_value_via_enum(value: float, metric: dict, metric_value: float):
    """
    Test case for value setting double via the ENUMs
    """
    for my_enum_type in [SPBBasicDataTypes, SPBMetricDataTypes, SPBPropertyValueTypes, SPBDataSetDataTypes]:
        my_enum_type(sparkplug_b_pb2.Double).set_value_in_sparkplug(value=value, spb_object=metric)
        assert (
...
def test_set_boolean_value_via_enum(value: bool, metric: dict, metric_value: bool):
    """
    Test case for value setting boolean via the ENUMs
    """
    for my_enum_type in [SPBBasicDataTypes, SPBMetricDataTypes, SPBPropertyValueTypes, SPBDataSetDataTypes]:
        my_enum_type(sparkplug_b_pb2.Boolean).set_value_in_sparkplug(value=value, spb_object=metric)
...
def test_set_string_value_via_enum(value: str, metric: dict, metric_value: str):
    """
    Test case for value setting String via the ENUMs
    """
    for my_enum_type in [SPBBasicDataTypes, SPBMetricDataTypes, SPBPropertyValueTypes, SPBDataSetDataTypes]:
        my_enum_type(sparkplug_b_pb2.String).set_value_in_sparkplug(value=value, spb_object=metric)
        assert (
...
def test_set_bytes_value_via_enum(value: bytes, metric: dict, metric_value: bytes):
    """
    Test case for value setting boolean via the ENUMs
    """
    SPBMetricDataTypes(sparkplug_b_pb2.Bytes).set_value_in_sparkplug(value=value, spb_object=metric)
