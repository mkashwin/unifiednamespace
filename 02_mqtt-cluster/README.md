...
1. **Step 1**: Download or install protoc. Refer
   ...
   - [Install pre-compiled version](https://github.com/protocolbuffers/protobuf/releases). This project currently is using version [Protocol Buffers v32.0](https://github.com/protocolbuffers/protobuf/releases/tag/v32.0)
...
1. The protoc executable for [Linux](./protobuf/bin/protoc) is for x86_64 architecture and will need execute rights to be able to run and compile the [sparkplug_b.proto](./sparkplug_b/sparkplug_b.proto) specification.
   ...
   - [protoc-32.0-win32.zip](https://github.com/protocolbuffers/protobuf/releases/download/v32.0/protoc-32.0-win32.zip)
