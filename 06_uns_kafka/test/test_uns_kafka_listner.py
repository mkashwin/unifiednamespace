...
def test_uns_kafka_mapper_init():
    ...
    try:
        ...
        if uns_kafka_mapper is not None:
            if (
                hasattr(uns_kafka_mapper, "kafka_handler")
                and getattr(uns_kafka_mapper, "kafka_handler", None)
                and hasattr(uns_kafka_mapper.kafka_handler, "producer")
                and getattr(uns_kafka_mapper.kafka_handler, "producer", None)
            ):
